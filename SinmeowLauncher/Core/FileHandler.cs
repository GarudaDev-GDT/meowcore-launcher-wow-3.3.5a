    ...
    public class FileHandler
    {
        ...
        public bool IsInWowDir()
        {
            ...
            else if (c.SubElText("Main", "KeepBlizzlikeMPQs") == "1")
            {
                ...
                blizzlikeMPQs.Add(cwd + @"\data\patch-5.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-6.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-7.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-a.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-b.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-c.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-e.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-f.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-s.mpq");
                blizzlikeMPQs.Add(cwd + @"\data\patch-w.mpq");
        ...
        private void PreBuildDownloadList()
        {
                ...
                foreach (string mpqFile in blizzlikeMPQs)
            {
                ...
                if (!blizzlikeMPQs.Contains(mpqFile.ToLower()))
                {
                    ...
                    if (onServer == null)
                        o.Output(c.SubElText("Messages", "NoNeedUpdate"));
